...
namespace DatevConnector.UI
{
    ...
    internal static class UITheme
    {
        ...
        internal static Image GetBaseIcon()
        {
            ...
            var stream = assembly.GetManifestResourceStream("DatevConnector.UI.Assets.bridge_icon.png");
            if (stream != null)
            {
                using (stream)
                {
        ...
        public static Image GetDatevLogo()
        {
            ...
            var assembly = Assembly.GetExecutingAssembly();
            var stream = assembly.GetManifestResourceStream("DatevConnector.UI.Assets.DATEVLogo.png");
            if (stream != null)
            {
                using (stream)
                {

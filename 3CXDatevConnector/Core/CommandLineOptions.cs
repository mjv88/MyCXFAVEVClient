...
{
    /// <summary>
    /// Command line options parser for 3CX - DATEV Connector.
    ...
    public class CommandLineOptions
    {
        ...
        {
            return @"3CX - DATEV Connector - Kommandozeilenoptionen

Verwendung: 3CXDatevConnector.exe [Optionen]
...
Beispiele:
  3CXDatevConnector.exe /silent /minimized
  3CXDatevConnector.exe /config=""C:\Config\custom.config""
